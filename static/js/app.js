// create url const variable
const url = "https://2u-data-curriculum-team.s3.amazonaws.com/dataviz-classroom/v1.1/14-Interactive-Web-Visualizations/02-Homework/samples.json"

//get the JSON data and check it in console
...
function drawBar(sampleId) {
    ...
    d3.json(url).then(data => {
        ...
        //Call the Plotly function to plot the bar chart
        Plotly.newPlot("bar", barTrace, barLayout);

    })
}

//Create a bubble chart to display the top 10 OTUs found in that individual.
...
function init() {
    ...
    //use d3 do get names to populate dropdown
    d3.json(url).then(data => {
